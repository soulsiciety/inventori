  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Form Ubah Stok Barang</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Form Edit Stok <?php echo $barang['nama_barang'];?></h3>
            ...
            <div class="box-body">
              <form method="post">
                <input type="hidden" name="id_b_masuk" value="<?php echo $barang['id_b_masuk'];?>">
                ...
                <div class="col-xs-8">
                  ...
                  <div class="form-group">
                    ...
                    <input type=" text" name="tgl_entry" class="form-control" value="<?php echo date("d-F-Y", strtotime($barang['tgl_entry']))?>" id="datepicker2">
                    <?php echo form_error('tgl_entry', '<span class="error">', '</span>'); ?>
                  </div>
                  <!-- /.form-group -->
                  <div class="form-group">
                    <label>Jumlah Barang Masuk</label>
                    <input type="number" name="qty_masuk" class="form-control" value="<?php echo $barang['qty_masuk'];?>">
                    <?php echo form_error('qty_masuk', '<span class="error">', '</span>'); ?>
                  </div>
                  <div class="form-group">
                    <label>Umur Manfaat (dalam tahun)</label>
                    <input type="number" name="umur_manfaat" class="form-control" min="1" max="5" value="<?php echo $barang['umur_manfaat'];?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    Simpan Perubahan Stok Barang</button>
                  </div>
                </div> <!-- close div col-xs-6 -->
              </form>
            </div>
