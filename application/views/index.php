...
<div class="wrapper">
  ...
  <div class="content" style="min-height: 200px !important; background: #fff;">
    ...
    <section class="content-header">
      <h1>
        Pilih Menu
        <small>Silahkan pilih menu di bawah ini : </small>
      </h1>
    </section>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h4><b>Peminjaman</b></h4>
              <p>Peminjaman barang <br>seperti Proyektor dll.</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h4><b>Pengambilan</b></h4>
              <p>Pengambilan barang <br>seperti tinta printer dll.</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h4><b>Service</b></h4>
              <p>Jika ada kerusakan <br>seperti komputer dll.</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h4><b>Kotak Saran</b></h4>
              <p>Saran dan Masukan<br> untuk kinerja unit TI.</p>
            </div>
            <div class="icon">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="http://stpbali.ac.id/">STP Nusa Dua Bali</a>.</strong> All rights
    reserved.
  </footer>
