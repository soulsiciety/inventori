...
<head>
  ...
  <title>Login Unit TI</title>
 
   <link rel="shortcut icon" href="<?php echo base_url();?>assets_2/images/bc_favicon.png">
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url();?>assets_1/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url();?>assets_1/index2.html"><b>Login</b> Petugas</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Silahkan Login Terlebih Dahulu</p>
    <?php echo $this->session->flashdata('message');?>
    <form action="<?php echo site_url('masuk/login_proses');?>" method="post">
